	...
	case WM_CREATE:
		{
			...
			hLv = CreateWindow(WC_LISTVIEW, TEXT("WC_LISTVIEW"), WS_CHILD | WS_VISIBLE | LVS_REPORT | WS_VSCROLL | WS_HSCROLL,topX,topY+HEIGHT*10,WIDTH*25,HEIGHT*5, hWnd, (HMENU)IDD_LV0, hInst, NULL);
